...
public class RequestThread extends Thread {
    ...
    public void run() {
        ...
        try {
            ...
            String[] ages = { "3067519627", "3067519628", "3067519629",
                    // who considers 30+ youth? probably a Freudian slip. anyway...
                    "3067519630", };

            var ageIndex = rng.nextInt(ages.length - 1);

            var doc = connection.data("463803414", ages[ageIndex]).data("463803684", App.MY_WORD_MORE_LIKE_SENTENCE)
            ...
            if (doc != null && doc.title().toString().equals("Gib uns dein Jugendwort 2020 Survey")) {
                successfullRequests++;
